from sqlalchemy import MetaData, create_engine, Integer, Column, String, ForeignKey, Float
from sqlalchemy.ext.declarative import declarative_base
from sqlalchemy.orm import sessionmaker, relationship

metadata = MetaData()
engine = create_engine('sqlite:///user_database.dms', connect_args={'check_same_thread': False}, echo=False)  # echo=False
